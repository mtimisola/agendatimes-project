                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="headline_section" class="form-control">
                                <option value="0" {{ old('headline_section') == '0' ? 'selected' : '' }}>None</option>
                                <option value="1" {{ old('headline_section') == '1' ? 'selected' : '' }}>Headline Section 1 (Main)</option>
                                <option value="2" {{ old('headline_section') == '2' ? 'selected' : '' }}>Headline Section 2 (Right-top)</option>
                                <option value="3" {{ old('headline_section') == '3' ? 'selected' : '' }}>Headline Section 3 (Right-bottom)</option>
                            </select>
                        </div>
                        ...
                        {{-- Subscriber Option --}}
                        <div class="form-group mb-4">
                            <label class="form-label">Want to send this to subscribers?</label>
                            <select name="subscriber_send_option" class="form-control">
                                <option value="1" {{ old('subscriber_send_option') == '1' ? 'selected' : '' }}>Yes</option>
                                <option value="0" {{ old('subscriber_send_option', '0') == '0' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
