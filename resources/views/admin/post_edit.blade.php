                ...
                <div class="card">
                    <div class="card-body">
                                        ...
                                        <div class="row g-2" id="quick-thumbnails">
                                            @foreach($photos->take(12) as $photo)
                                                <div class="col-6 col-md-3 col-lg-2">
                                                    <div class="gallery-thumb card h-100 {{ (isset($post_single->photo_id) && $post_single->photo_id == $photo->id) ? 'selected' : '' }}" data-id="{{ $photo->id }}" data-caption="{{ $photo->caption }}">
                                                        ...
                                                        <div class="card-body p-2 text-center">
                                                            ...
                                                            <div class="form-check mt-2">
                                                                <input class="form-check-input" type="radio" name="photo_id" value="{{ $photo->id }}" 
                                                                       id="photo_{{ $photo->id }}" {{ (isset($post_single->photo_id) && $post_single->photo_id == $photo->id) ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="card-body p-2 text-center">
                                                                        ...
                                                                        <div class="form-check mt-2">
                                                                            <input class="form-check-input" type="radio" name="photo_id" 
                                                                                   ...
                                                                                   {{ (isset($post_single->photo_id) && $post_single->photo_id == $photo->id) ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="headline_section" class="form-control">
                                <option value="0" @if($post_single->headline_section == 0) selected @endif>None</option>
                                <option value="1" @if($post_single->headline_section == 1) selected @endif>Headline Section 1 (Main)</option>
                                <option value="2" @if($post_single->headline_section == 2) selected @endif>Headline Section 2 (Right-top)</option>
                                <option value="3" @if($post_single->headline_section == 3) selected @endif>Headline Section 3 (Right-bottom)</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="language_id" class="form-control">
                                ...
                                <option value="{{ $row->id }}" @if($row->id == $post_single->language_id) selected @endif>
                                    {{ $row->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <select name="status" class="form-control">
                                <option value="published" @if(($post_single->status ?? 'published') == 'published') selected @endif>Published</option>
                                <option value="pending" @if(($post_single->status ?? '') == 'pending') selected @endif>Pending</option>
                                <option value="draft" @if(($post_single->status ?? '') == 'draft') selected @endif>Draft</option>
                            </select>
                        </div>
                    ...
                    <div class="card-footer bg-transparent">
                        ...
                        <a href="{{ route('admin_post_show') }}" class="btn btn-secondary">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
