...
Route::post('/search/result', [App\Http\Controllers\Front\HomeController::class, 'search'])->name('search_result');
...
Route::post('/comment/store', [\App\Http\Controllers\Front\CommentController::class, 'store'])->name('comment_store');
Route::post('/comment/like/{id}', [\App\Http\Controllers\Front\CommentController::class, 'like'])->name('comment_like');
Route::post('/comment/dislike/{id}', [\App\Http\Controllers\Front\CommentController::class, 'dislike'])->name('comment_dislike');

// Admin comment management
Route::get('/admin/comments', [\App\Http\Controllers\Admin\AdminCommentController::class, 'index'])->name('admin_comments_index')->middleware('admin:admin');
Route::post('/admin/comment/delete/{id}', [\App\Http\Controllers\Admin\AdminCommentController::class, 'delete'])->name('admin_comment_delete')->middleware('admin:admin');